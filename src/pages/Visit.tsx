    ...
    <>
      ...
      <section className="bg-background reverence">
        <div className="mx-auto max-w-4xl px-6 md:px-10 text-center">
          ...
          <RevealOnView variant="ink-rise" delay={120} as="div">
            <ScriptureRef
      ...
      <section className="bg-background py-20 md:py-28">
        <div className="mx-auto max-w-6xl px-6 md:px-10">
          <div className="mx-auto max-w-2xl text-center">
            <RevealOnView variant="eyebrow-spread" as="div" className="mb-4 flex justify-center">
              <SacredEyebrow>{t.visit.expect.eyebrow}</SacredEyebrow>
            </RevealOnView>
            <RevealOnView variant="title-bloom" delay={120} as="h2" className="font-display text-4xl md:text-5xl">
              {t.visit.expect.title}
            </RevealOnView>
          </div>
      ...
      <section className="bg-secondary/40 py-20 md:py-28">
        <div className="mx-auto max-w-5xl px-6 md:px-10">
          ...
          <RevealOnView variant="title-bloom" delay={120} as="h2" className="mb-12 font-display text-4xl md:text-5xl">
            {t.visit.when.title}
          </RevealOnView>
          <RevealOnView variant="ink-rise" delay={200} as="div" className="grid gap-6 md:grid-cols-2">
          ...
          <RevealOnView variant="rise" delay={300} as="div" className="relative overflow-hidden cross-watermark mt-10 rounded-2xl bg-gradient-navy p-8 shadow-elegant">
          ...
          <RevealOnView variant="fade" delay={400} as="div" className="mt-12 text-center">
