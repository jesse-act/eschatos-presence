...
const Contact = () => {
  ...
  return (
    <>
      ...
      {/* Scripture — Sa promesse */}
      <section className="bg-background reverence">
        <div className="mx-auto max-w-4xl px-6 md:px-10 text-center">
          <div className="mb-8 flex justify-center">
            <SacredEyebrow>Sa promesse</SacredEyebrow>
          </div>
          <ScriptureRef
        ...
        <div className="mx-auto grid max-w-6xl gap-16 px-6 md:px-10 lg:grid-cols-2">
          ...
          <div>
            ...
            <form onSubmit={onSubmit} className="space-y-5">
              ...
              <Button type="submit" variant="hero" size="lg" disabled={submitting} className="glory w-full sm:w-auto">
          ...
          <div className="space-y-10">
            <div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={c.city} className="rounded-2xl border border-border bg-card p-6 shadow-soft transition-all duration-500 hover:shadow-anoint">
                    <h3 className="font-display text-xl">{c.city}</h3>
                    <p className="mt-2 flex items-start gap-2 text-sm text-muted-foreground">
                      <MapPin className="mt-0.5 h-4 w-4 text-accent animate-breath-soft" /> {c.addr}
                    </p>
                    <p className="mt-1 flex items-center gap-2 text-sm text-muted-foreground">
                      <Phone className="h-4 w-4 text-accent animate-breath-soft" /> {c.phone}
                    </p>
            ...
            <div>
              ...
              <p className="mb-4 flex items-center gap-2 text-sm text-muted-foreground">
                <Mail className="h-4 w-4 text-accent animate-breath-soft" /> hello@eschatos.church
              </p>
              <div className="flex gap-3">
                {[
                  ...
                  <a
                    ...
                    rel="noreferrer"
                    aria-label={label}
                    className="grid h-11 w-11 place-items-center rounded-full border border-border text-foreground transition-all duration-300 hover:-translate-y-0.5 hover:scale-110 hover:border-accent hover:text-accent hover:shadow-anoint transition-transform"
                  >
