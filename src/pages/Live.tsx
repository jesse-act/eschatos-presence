    ...
    <>
      ...
      <section className="bg-background py-20 md:py-28">
        <div className="mx-auto max-w-5xl px-6 md:px-10">
          ...
          <div className="mt-12 flex flex-col items-center gap-4 rounded-2xl border border-border bg-card px-8 py-10 text-center shadow-soft md:flex-row md:text-left">
